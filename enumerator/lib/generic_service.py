...
class GenericService(object):
    ...
    def __init__(self):
        self.compiled_service_definition = self.compile_service_definition(self.SERVICE_DEFINITION)
    ...
    def compile_service_definition(self, definition):
        ...
        for rule_set in rule_parser_pattern.findall(definition):
            ...
            # Rule: If there are '-' values at the beginning of each value, split apart.
